            ...
            <table id="myTable">
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a class="text-decoration-none" href="updateEmployeee.php?id=<?php echo $row["id"] ?>">
                                    <i class="fa fa-file " style="color:green;" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;
                                </a>
                                <a class="text-decoration-none" href="./action/employeeDelete.php?id=<?php echo $row["id"] ?>">
