...
<html>
	...
	<body>
		...
		if($result->num_rows> 0)
		{
			...
			{
				?>
				<form method="post" action="makeup.php?action=add&id=<?php echo $row["id"]; ?>">
					<div class="card">
						<img src="images/<?php echo $row["image"]; ?>" class="img-responsive" /><br />
						<?php
						echo("<h4 class='text-info'>" .$row["pname"]. "</h4>");
			...
			<div class="container">
				<table class="table">
					...
					<?php
						...
						<td><a href="makeup.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="button">Remove</span></a></td>
					</tr>
					<?php
							//calculate total
