	...
	<body>
		...
		<div class="container">
			...
			//accessing product table from database
				$sql = "SELECT * FROM skin ORDER BY id ASC";
			...
			while($row = $result->fetch_assoc())
			{
				...
				<form method="post" action="skin.php?action=add&id=<?php echo $row["id"]; ?>">
					<div class="card">
						...
						<?php
						echo("<h4 class='text-info'>" .$row["sname"]. "</h4>");
			...
			<div class="container">
				<table class="table">
					...
					<?php
						...
						<td><a href="skin.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="button">Remove</span></a></td>
					</tr>
					<?php
							//calculate total
